...
//   import {Url} from "../../utils/global";  //上传图片和视频的地址，根据后端给的地址确定
...
export default {
    ...
    methods: {
        ...
        seteditor() {
            ...
            this.editor.config.uploadImgServer = '/api/dress/file/upload'// 填写配置服务器端地址
            ...
            this.editor.config.uploadImgHooks = {
                ...
                customInsert: (insertImg, result, editor) => {
                    ...
                    // result.data.fileInfoVO.url = ACSetManageUrl + result.data.fileInfoVO.url

                    insertImg(result.data.fileInfoVO.url)
                }
            }
            ...
            this.editor.config.uploadVideoServer = '/api/dress/file/upload'// 填写配置服务器端地址
